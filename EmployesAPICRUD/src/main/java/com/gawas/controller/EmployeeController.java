...
import com.gawas.repository.EmployeeRepository;
...
public class EmployeeController 
{
	...
	public ResponseEntity<Employee> getEmloyeeById(@PathVariable long empid) 
	{
	...
	public String updateEmployeeById(@PathVariable long empid,@RequestBody Employee employee) 
	{
		...
		if(emp.isPresent())
		{
			...
			existEmp.setEage(employee.getEage());
			existEmp.setEsal(employee.getEsal());
			existEmp.setEcity(employee.getEcity());
